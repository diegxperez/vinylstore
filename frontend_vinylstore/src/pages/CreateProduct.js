  ...
  const view = `
     <div>
      ...
      <form id="create-product-form" class="max-w-sm mx-auto">
        ...
        <button type="submit"
          class="text-gray-800 bg-blue-100 hover:bg-blue-00 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Registrar</button>
      </form>
      </div>
  `;
